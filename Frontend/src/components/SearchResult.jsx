...
const SearchResult = () => {
  ...
  const { events, searchEventsByFilter, isLoadingEvents, pagination } = useEventStore();
  ...
  useEffect(() => {
    searchEventsByFilter(category, location, page).catch(() =>
  ...
  return (
    <div className="px-6 py-10 bg-base-100 min-h-screen mt-3">
      <h2 className="text-3xl font-bold mb-8 text-center">Filtered Events</h2>
